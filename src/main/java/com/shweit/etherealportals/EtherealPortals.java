...
public class EtherealPortals extends JavaPlugin {
  ...
  public com.shweit.etherealportals.visual.VisualEffectTask getVisualTask() { return visualTask; }
  public double getHitboxWidth() { return hitboxWidth; }
  public double getHitboxDepth() { return hitboxDepth; }
  ...
  public void onEnable() {
    ...
    cooldownManager = new CooldownManager(getConfig().getInt("portal.teleport.cooldownSeconds", 3), getConfig().getInt("portal.teleport.messageCooldownSeconds", 1));
  ...
  public void onDisable() {
    ...
    if (visualTask != null) visualTask.stop();
  }
  ...
  public void reloadLocalConfig() {
    ...
    if (cooldownManager != null) {
      cooldownManager.updateConfig(getConfig().getInt("portal.teleport.cooldownSeconds", 3), getConfig().getInt("portal.teleport.messageCooldownSeconds", 1));
    }
  }
